...
class TrackDetailModel {
  ...
  final String? share;
  final num? duration;
  final num? trackPosition;
  final num? diskNumber;
  final num? rank;
  final DateTime? releaseDate;
  final bool? explicitLyrics;
  final num? explicitContentLyrics;
  final num? explicitContentCover;
  ...
  factory TrackDetailModel.fromRawJson(String str) => TrackDetailModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TrackDetailModel.fromJson(Map<String, dynamic> json) => TrackDetailModel(
    id: json["id"],
...
class Contributor {
  ...
  factory Contributor.fromRawJson(String str) => Contributor.fromJson(json.decode(str));
